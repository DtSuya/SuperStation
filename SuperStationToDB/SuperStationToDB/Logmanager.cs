...
namespace Utility.SuperStation
{
    ...
    public static class LogManager
    {
        ...
        /// 写日志
        /// </summary>
        /// <param name="describe">功能类型描述</param>
        /// <param name="ex">捕获的错误</param>
        public static void WriteLog(string describe, Exception ex)
        {
            WriteLog(LogFile.Error, describe, ex);
        }
        /// <summary>
        /// 写日志
        /// </summary>
        ...
        /// <param name="describe">功能类型描述</param>
        /// <param name="ex">捕获的错误</param>
        public static void WriteLog(LogFile logfile, string describe, Exception ex)
        {
            try
            {
                DateTime logTime = DateTime.Now;
                ...
                StreamWriter sw = System.IO.File.AppendText(LogPath + logfile.ToString() + "_" + logTime.ToString("yyyyMMdd") + ".Log ");
                sw.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                sw.WriteLine("Describe:" + Environment.NewLine + describe + Environment.NewLine);
                sw.WriteLine("Message:" + Environment.NewLine + ex.Message + Environment.NewLine);
                sw.WriteLine("StackTrace:" + Environment.NewLine + ex.StackTrace + Environment.NewLine);
                sw.Close();
            }
